...
R3BCalifaPoint::R3BCalifaPoint()
  : FairMCPoint(),
    ...
    fCrystalId(-1), fNf(0.), fNs(0.)
{
}
// -------------------------------------------------------------------------

// -----   Standard constructor   ------------------------------------------
R3BCalifaPoint::R3BCalifaPoint(Int_t trackID, Int_t detID, Int_t ident,
  ...
  : FairMCPoint(trackID, detID, posIn, momIn, tof, length, eLoss),
    ...
    fCrystalId(ident), fNf(Nf), fNs(Nf)
{
}
// -------------------------------------------------------------------------
...
void R3BCalifaPoint::Print(const Option_t* opt) const {
  cout << "-I- R3BCalifaPoint: CALIFA Point for track " << fTrackID
       << " in crystal " << fCrystalId << endl;
