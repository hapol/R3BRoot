...
class R3BCalifa : public R3BDetector
{
 ...
 public:
  ...
  void SetRegisterPoint(Int_t value=1);
  //  void SaveGeoParams();
 ...
 private:
  ...
  TClonesArray* fCalifaCrystalCalCollection; //!  The crystal hit collection
  ...
  // Selecting the geometry of the CALIFA calorimeter (only official version now available)
  Int_t fGeometryVersion;

  // Selecting the objects to register
  Int_t fRegisterMode;
